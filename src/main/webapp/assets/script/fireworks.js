...
let personneData = document.getElementById("personne-data");
let prenom = personneData.getAttribute("data-prenom")
class Firework {
...
function animate() {
    ...
    ctx.fillText(prenom, canvas.width/2/window.devicePixelRatio, canvas.height/2/window.devicePixelRatio);
}
